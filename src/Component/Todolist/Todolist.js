...
const Todolist = () => {
  ...
  const handleEvent = () => {
    if (edit === true) {
      ...
      console.log(obj);
      obj.todovalue === ""
        ? setArray(array) || setEmpty(true)
        : setArray([...array, obj]) || setEmpty(false);
    }
    ...
    <section className="todo-sec">
      <div className="todo-container">
        ...
        <div className="todo-row">
          ...
          {empty === true ? (
            <p className="error-msg">Please Enter your totdos</p>
          ) : (
            ""
          )}
          <div className="todos">
            <button
              onClick={todoslist}
              style={allTodosactive === true ? color : null}
            >
              All
            </button>
            <button
              onClick={startingtodos}
              style={startTodosactive === true ? color : null}
            >
              Start
            </button>
            <button
              onClick={progressTodos}
              style={progressTodosactive === true ? color : null}
            >
              Progress
            </button>
            <button
              onClick={pendingtodos}
              style={pendingTodosactive === true ? color : null}
            >
              Pending
            </button>
            <button
              onClick={completetodos}
              style={completeTodosactive === true ? color : null}
            >
              Completed
            </button>
          </div>
                ...
                return (
                  <div className="todo-box" key={i}>
                    <div className="todo-values">
                      ...
                      <div className="icons">
                        <RiDeleteBin6Line
                          onClick={() => handleDelete(e.todovalue)}
                          className="del-icon"
                        />
                        <BiSolidEdit
                        ...
                        <TiTick
                          onClick={() =>
                            handleTick(e.todovalue, e.tododescription)
                          }
                          style={{ color: "green" }}
                        />
                      </div>
